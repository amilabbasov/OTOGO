...
const SoleProviderPersonalInfoScreen = () => {
  ...
  const validateForm = () => {
    ...
    if (!businessName.trim()) {
      Alert.alert(t('Error'), t('Please enter your business name'));
      return false;
    }
          ...
          <View style={styles.innerContent}>
            <View style={styles.contentPadding}>
              <View style={styles.header}>
                <Text style={styles.title}>Sole Provider</Text>
                <Text style={styles.title}>Information</Text>
                <Text style={styles.subtitle}>
                  Please fill in your business information to complete your provider profile
                </Text>
              </View>
