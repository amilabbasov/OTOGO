...
const SoleProviderProductsScreen = () => {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      await updateServices(selectedTags, 'individual_provider');
      
      // Complete the individual provider registration flow
      Alert.alert(
        t('Success'),
  ...
  const renderServiceTag = ({ item }: { item: any }) => (
    ...
    >
      <View style={styles.serviceTagIcon}>
        <Text style={styles.serviceTagEmoji}>🏷️</Text>
      </View>
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>Products You</Text>
