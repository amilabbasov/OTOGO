...
const vehicleTypes: VehicleType[] = [
  ...
  },
  {
    id: 'fleet',
    name: 'Fleet Services',
    description: 'Multiple vehicle fleet services',
    icon: '🚚',
    services: ['exterior_wash', 'interior_clean', 'maintenance', 'inspection'],
    capacity: '5+ vehicles',
  },
  {
    id: 'motorcycle',
  ...
  },
  {
    ...
    capacity: '1-3 vessels',
  },
];

const CorporateProviderCarSelectionScreen = () => {
    ...
    >
      ...
      <View style={styles.vehicleTypeInfo}>
        ...
        <Text style={styles.vehicleTypeServices}>
          {item.services.length} service{item.services.length !== 1 ? 's' : ''} • {item.capacity}
        </Text>
      </View>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Choose the types of vehicles your company can provide services for
          </Text>
        </View>
...
export default CorporateProviderCarSelectionScreen; 